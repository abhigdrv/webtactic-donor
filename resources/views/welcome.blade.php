...
<!-- Mirrored from html.flytemplates.com/onehope/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Feb 2021 10:21:45 GMT -->
...
<head>
    ...
    <!-- FontAwesome -->
    <link href="onehope/css/font-awesome.css" media="screen" rel="stylesheet" type="text/css" />

    <!-- Select 2 -->
    <link href="onehope/css/select2.css" media="screen" rel="stylesheet" type="text/css" />

    <!-- Core CSS -->
    <link href="onehope/css/bootstrap.css" media="screen" rel="stylesheet" type="text/css" />
    <link href="onehope/style.css" media="screen" rel="stylesheet" type="text/css" />

    <!-- Animate.css -->
    <link href="onehope/css/animate.css" media="screen" rel="stylesheet" type="text/css" />

    <!-- Modernizr Library -->
    <script src="onehope/js/libs/modernizr-3.6.0.min.js"></script>
</head>
    ...
    <nav class="navigation-bar" data-become-sticky="600" data-no-placeholder>
        <div class="container">
            ...
            <div class="navigation-bar-flex">
                ...
                <div class="logo">
                    <a href="index-2.html">
                        <!--<img class="logo-normal" src="onehope/images/logo-x2.png" alt=""/>
                        <img class="logo-sticky" src="onehope/images/logo-sticky-x2.png" alt=""/>-->
                        One<span>Hope</span>
                    </a>
                </div>
                <!--/ Logo -->
                ...
                <ul class="nav-menu clearfix" itemscope itemtype="http://schema.org/SiteNavigationElement">
                    <li class="current-menu-item">
                        <a href="#">Home</a>
                        <ul>
                            <li><a href="index-2.html">Home Fly Slider</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="projects-4cols.html">Projects 4 Columns</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="blog-2cols.html">2 Columns</a></li>
                            <li><a href="blog-3cols.html">3 Columns</a></li>
                            <li><a href="blog-4cols.html">4 Columns</a></li>
...
<!--/ Header -->
    ...
    <div class="fly-slider invisible" data-rotation-interval="10000" data-rotation-duration="1000">
        <div class="cube">
            <section class="slide" style="background-image: url(onehope/images/temp/slide-1.jpg);">
            ...
            <section class="slide" style="background-image: url(onehope/images/temp/slide-2.jpg);">
                <div class="slide-content">
            ...
            <section class="slide" style="background-image: url(onehope/images/temp/slide-3.jpg);">
                <div class="slide-content">
                    <h2 class="page-title">Helping Hands for Everyone</h2>
            ...
            <section class="slide" style="background-image: url(onehope/images/temp/slide-4.jpg);">
                <div class="slide-content">
                    <h2 class="page-title">Helping Hands for Everyone</h2>
    ...
    <section class="flex-container fly-services">
        <div class="fly-service">
            ...
            <div class="service-buttons">
                <a href="#" class="btn btn-medium js-wave">READ MORE</a>
            </div>
        </div>
            ...
            <div class="fly-projects alternate-layout">
                ...
                <article class="fly-card fly-project fly-flip-effect vertical" itemscope itemtype="http://schema.org/DonateAction">
                    <div class="boxed flip-front">
                        <a class="project-media js-wave" href="project-details.html" itemprop="url">
                            <img src="onehope/images/temp/project-7.jpg" alt="" itemprop="image" />
                            <span class="progress">
                        ...
                        <div class="project-content">
                            ...
                            <div class="project-description" itemprop="description">
                                <p>
                                    ...
                                    possim assum. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consectissim posuere cubilia Curae
                                    Suspendisse at consectetur massa.
                                </p>
                            </div>
                            ...
                            <div class="project-footer">
                                ...
                                <div class="project-buttons">
                                    <a href="project-details.html#donateForm" class="btn btn-yellow js-wave" itemprop="potentialAction">Donate</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <article class="fly-card fly-project fly-flip-effect vertical" itemscope itemtype="http://schema.org/DonateAction">
                    <div class="boxed flip-front">
                        <a class="project-media js-wave" href="project-details.html" itemprop="url">
                            <img src="onehope/images/temp/project-8.jpg" alt="" itemprop="image" />
                            <span class="progress">
                                <span class="progress-label">0%</span>
                                <span class="progress-bar"></span>
                            </span>
                ...
                <article class="fly-card fly-project fly-flip-effect vertical" itemscope itemtype="http://schema.org/DonateAction">
                    <div class="boxed flip-front">
                        <a class="project-media js-wave" href="project-details.html" itemprop="url">
                            <img src="onehope/images/temp/project-9.jpg" alt="" itemprop="image" />
                            <span class="progress">
                                <span class="progress-label">0%</span>
                                <span class="progress-bar"></span>
                            </span>
    ...
    <!-- Call To Action -->
    <section class="section section-cta parallax" style="background-image: url(onehope/images/temp/slide-5.jpg);">
        <div class="container">
            ...
            <div class="fly-events flex-container">
                    ...
                    <article class="fly-card fly-event fly-flip-effect" itemscope itemtype="http://schema.org/Event">
                        <div class="boxed flip-front">
                            <a class="event-media js-wave" href="event-details.html" itemprop="url">
                                <img src="onehope/images/temp/event-1.jpg" alt="" itemprop="image" />
                            </a>
                ...
                <div class="column">
                    ...
                    <article class="fly-card fly-event fly-flip-effect" itemscope itemtype="http://schema.org/Event">
                        <div class="boxed flip-front">
                            <a class="event-media js-wave" href="event-details.html" itemprop="url">
                                <img src="onehope/images/temp/event-2.jpg" alt="" itemprop="image" />
                            </a>
    ...
    <!-- Testimonials -->
    <section class="section gray section-testimonials" style="background-image: url(onehope/images/map.png);">
        <div class="section-heading">
            <div class="container">
                            ...
                            <div class="testimonials-slider">
                                <article class="testimonial">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="avatar"><img src="onehope/images/temp/avatar-1.jpg" alt=""/></div>
                                ...
                                <article class="testimonial">
                                    ...
                                    <div class="testimonial-author">
                                        <div class="avatar"><img src="onehope/images/temp/avatar-2.jpg" alt=""/></div>
    ...
    <!-- Statistics -->
    <section class="section section-stats parallax" style="background-image: url(onehope/images/temp/slide-6.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-sm-3">
                    <div class="stats-item">
                        <div class="counter js-counter" data-duration="2" data-step=".1">31524</div>
                        <div class="description">DONATIONS MADE</div>
                    </div>
                </div>

                <div class="col-xs-6 col-sm-3">
                    <div class="stats-item">
                        <div class="counter js-counter" data-duration="2" data-step=".1">247441</div>
                        <div class="description">LITERS OF WATER SPENT</div>
                    </div>
                </div>

                <div class="col-xs-6 col-sm-3">
                    <div class="stats-item">
                        <div class="counter js-counter" data-duration="2" data-step=".1">41304</div>
                        <div class="description">EDUCATION FOR PEOPLE</div>
                    </div>
                </div>
            ...
            <div class="fly-articles columns3 flex-container">
                    ...
                    <article class="fly-card fly-article boxed" itemscope itemtype="http://schema.org/Article">
                        <div class="boxed">
                            <a class="post-media js-wave" href="blog-details.html" itemprop="url">
                                <img src="onehope/images/temp/post-1.jpg" alt="" itemprop="image" />
                            </a>
                ...
                <div class="column">
                    ...
                    <article class="fly-card fly-article boxed" itemscope itemtype="http://schema.org/Article">
                        <div class="boxed">
                            <a class="post-media js-wave" href="blog-details.html" itemprop="url">
                                <img src="onehope/images/temp/post-2.jpg" alt="" itemprop="image" />
                            </a>
                ...
                <div class="column">
                    ...
                    <article class="fly-card fly-article boxed" itemscope itemtype="http://schema.org/Article">
                        <div class="boxed">
                            <a class="post-media js-wave" href="blog-details.html" itemprop="url">
                                <img src="onehope/images/temp/post-3.jpg" alt="" itemprop="image" />
                            </a>
    ...
    <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="widget-footer widget-posts">
                        ...
                        <article class="fly-article" itemscope itemtype="http://schema.org/Article">
                            <div class="post-content" itemprop="articleBody">
                                <h3 class="post-title"><a href="#" itemprop="name">Lorem ipsum dolor sit amet, consetetur sadipscing elitr</a></h3>

                                <div class="post-meta">
                                    <time class="post-date" datetime="2016-12-11T20:10:22" itemprop="dateCreated">11th Dec. 2016 - 10:22 AM</time>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="fly-article" itemscope itemtype="http://schema.org/Article">
                            <div class="post-content" itemprop="articleBody">
                                <h3 class="post-title"><a href="#" itemprop="name">Duis autem vel eum iriure dolor in hendrerit</a></h3>

                                <div class="post-meta">
                                    <time class="post-date" datetime="2016-12-11T20:08:44" itemprop="dateCreated">11th Dec. 2016 - 08:44 AM</time>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="widget-footer widget-twitter">
                        ...
                        <article class="tweet">
                            <a href="#" class="tweet-link">@OneHope consetetur sadipscing elitr, sed diam nonumy...</a>
                            <time class="tweet-date" datetime="2016-12-11T20:08:44"># 2 hours ago</time>
                        </article>

                        <article class="tweet">
                            <a href="#" class="tweet-link">Duis autem vel eum iriure @OneHope dolor in hendrerit in vulputate...</a>
                            <time class="tweet-date" datetime="2016-12-11T20:08:44"># 4 hours ago</time>
                        </article>
                    </div>
                    <!--/ Widget Twitter -->
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="widget-footer widget-gallery">
                        ...
                        <ul>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-1.jpg" alt=""/></a></li>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-2.jpg" alt=""/></a></li>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-3.jpg" alt=""/></a></li>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-4.jpg" alt=""/></a></li>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-5.jpg" alt=""/></a></li>
                            <li><a href="#" class="js-wave"><img src="onehope/images/temp/gallery-6.jpg" alt=""/></a></li>
                        </ul>
                    </div>
                    <!--/ Widget Gallery -->
                </div>
        ...
        <div class="footer-bottom flex-container">
            ...
            <div class="footer-copyright">
                &copy; <span itemprop="copyrightYear">2019</span> by <a rel="nofollow" href="http://flytemplates.com/" target="_blank" itemprop="copyrightHolder">FlyTemplates</a> | OneHope Donation Template
            </div>
            <!--/ Copyright -->
        </div>
    </div>
...
<!-- Libs -->
<script src="onehope/js/libs/jquery-1.12.2.min.js"></script>
<script src="onehope/js/libs/jquery-ui-1.11.4.min.js"></script>
<script src="onehope/js/libs/bootstrap-3.3.6.min.js"></script>

<!-- Placeholders -->
<script src="onehope/js/jquery.powerful-placeholder.min.js"></script>

<!-- Select2  -->
<script src="onehope/js/select2.full.min.js"></script>

<!-- InputMask -->
<script src="onehope/js/inputmask.min.js"></script>
<script src="onehope/js/jquery.inputmask.min.js"></script>

<!-- LightBox -->
<script src="onehope/js/jquery.swipebox.min.js"></script>

<!-- Owl Slider -->
<script src="onehope/js/owl.carousel.js"></script>

<!-- CarouFredSel -->
<script src="onehope/js/jquery.carouFredSel-6.2.1-packed.js"></script>

<!-- MouseWheel -->
<script src="onehope/js/jquery.mousewheel.min.js"></script>

<!-- TouchSwipe -->
<script src="onehope/js/jquery.touchSwipe.min.js"></script>

<!-- ScrollBar -->
<script src="onehope/js/jquery.nicescroll.min.js"></script>

<!-- StickyKit -->
<script src="onehope/js/jquery.sticky-kit.min.js"></script>

<!-- TweenLite, used for smooth scrolling -->
<script src="onehope/js/TweenLite.min.js"></script>
<script src="onehope/js/ScrollToPlugin.min.js"></script>

<!-- Google Map -->
<script src="https://maps.google.com/maps/api/js?key=AIzaSyBsiIXmVIO8K_S-f6_Ln0AjnYdvc3ttx9U"></script>
<script src="onehope/js/jquery.gmap.min.js"></script>
<script src="onehope/js/gmap-style.js"></script>
<script src="onehope/js/gmap-init.js"></script>

<!-- Youtube Api -->
<script src="https://www.youtube.com/iframe_api"></script>

<!-- FroogaLoop for Vimeo  -->
<script src="onehope/froogaloop2.min.js"></script>

<!-- Waves -->
<script src="onehope/js/waves.min.js"></script>

<!-- Object Fit PolyFill -->
<script src="onehope/js/ofi.browser.js"></script>

<!-- General Scripts -->
<script src="onehope/js/general.js"></script>

</body>

<!-- Mirrored from html.flytemplates.com/onehope/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Feb 2021 10:22:12 GMT -->
</html>