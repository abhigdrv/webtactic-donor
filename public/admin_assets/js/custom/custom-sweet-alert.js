    ...
    'use strict';
        ...
        $("body").on("click", ".sa-params", function() { 
            ...
            swal({
                ...
                $.get('delete-category-by-ajax', { category_id: categoryId}, 
        ...
        /* -- Sweet Alert - Parameter -- */
        $("body").on("click", ".delete-subcat-sa-params", function() { 
            ...
            swal({
                ...
                $.get('delete-subcategory-by-ajax', { subcategory_id: subcategoryId}, 
                                        function(returnedData){
                                             console.log(returnedData);                                             
                                    });
                swal(
        ...
        /* -- Sweet Alert Add Subcategory - Ajax -- */
        $("body").on("click", ".add-subcategory-sa-ajax", function() { 
            var categoryId = $(this).data("id")     
            swal({
                    ...
                    return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                            if (email === 'websbooster@gmail.com') {
                                ...
                                $.get('add-subcategory-by-ajax', { category_id: categoryId, category_name: email}, 
                                        function(returnedData){
                                             console.log(returnedData);                                             
                                    });
                                resolve()
                ...
                swal({
                    ...
                    html: 'Subcategory Name: ' + email
                })
            })
        });

        /* -- Sweet Alert - Ajax -- */
        $("body").on("click", ".edit-category-sa-ajax", function() { 
            ...
            swal({
                    ...
                    return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                            if (email === 'websbooster@gmail.com') {
                                ...
                                $.get('edit-category-by-ajax', { category_id: editcategoryId, category_name: email}, 
                                        function(returnedData){
                                             console.log(returnedData);                                             
                                    });
                                resolve()
                ...
                swal({
                    type: 'success',
                    title: 'Category Name Has Been Changed Successfully!',
                    html: 'Name Changed To: ' + email
                })
            })
        });

        /* -- Sweet Alert - Ajax -- */
        $("body").on("click", ".edit-subcategory-sa-ajax", function() { 
            var editsubcategoryId = $(this).data("id")     
            swal({
                title: 'Edit Category',
                input: 'text',
                showCancelButton: true,
                    ...
                    return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                            if (email === 'websbooster@gmail.com') {
                                ...
                                $.get('edit-subcategory-by-ajax', { subcategory_id: editsubcategoryId, subcategory_name: email}, 
                                        function(returnedData){
                                             console.log(returnedData);                                             
                                    });
                                resolve()
                ...
                swal({
                    type: 'success',
                    title: 'Subcategory Name Has Been Changed Successfully!',
                    html: 'Name Changed To: ' + email
                })
            })
        });
